...
I build the machinery for AI agents that outlive their sessions —
and run them daily as my own infrastructure.
...
- Zenn (ja): https://zenn.dev/synforger
- X: [@synforger](https://x.com/synforger)
